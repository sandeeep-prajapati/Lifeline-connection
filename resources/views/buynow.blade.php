...
<body>
    ...
    <div id="dashboard" style="display: none;">
        ...
        <div id="user-details">
            ...
            <p><strong>id:</strong>{{$all->id}}</p>
            <p><strong>Contact Number 1: </strong>{{$all->contact1}}</p>
            <p><strong>Contact Number 2: </strong> {{$all->contact2}}</p>
            <p><strong>Bed Number:</strong> {{$all->bed}}</p>
